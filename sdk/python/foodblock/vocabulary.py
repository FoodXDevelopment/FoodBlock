        ...
        'fields': {
            'biz_step': {
                ...
                'aliases': [
                    ...
                    'sampling', 'sensor_reporting', 'shelving', 'shipping', 'staging_outbound',
                    'stock_taking', 'stocking', 'storing', 'transforming', 'transporting',
            ...
            'disposition': {
                ...
                'aliases': [
                    ...
                    'partially_dispensed', 'recall', 'reserved', 'retail_sold', 'returned',
